...
import com.example.esemkablogger.databinding.ItemProfilePostBinding
...
class PostProfileAdapter(
    ...
    class ViewHolder(val binding: ItemProfilePostBinding): RecyclerView.ViewHolder(binding.root)
