...
import com.example.esemkablogger.databinding.FragmentLikedPostBinding
...
class LikedPostFragment : Fragment() {
    private var _binding: FragmentLikedPostBinding? =  null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLikedPostBinding.inflate(layoutInflater, container, false)
        showData()
        return binding.root
    }
